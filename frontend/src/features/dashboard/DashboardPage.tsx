...
import { Zap, Shield, RefreshCw, BarChart3, Activity } from 'lucide-react';
                ...
                <div className="max-w-[1800px] mx-auto px-6 py-4 flex justify-between items-center bg-[#080d18]">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <button
                            ...
                            className="px-6 py-2.5 rounded-lg bg-ui-accent hover:bg-ui-accent/90 hover:shadow-[0_0_20px_rgba(45,122,237,0.3)] text-white text-[11px] font-black tracking-widest uppercase transition-all active:scale-95 disabled:opacity-30 flex items-center gap-3"
                        >
                            {scanMutation.isPending ? <RefreshCw className="w-3 h-3" /> : <Activity className="w-3 h-3" />}
